...
interface DrumsKeyProps {
    ...
    octave: number;
    index: number; // octave + index together give a location for the Drums key
}
...
function DrumsKeyWithoutJSX({
     ...
     * See `DrumsKey` for the React component with JSX (JavaScript XML).
     */
